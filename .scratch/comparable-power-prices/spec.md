...
- Label the reference “Referencia: 1 kW en cada periodo”. Keep it visible for unequal contracted powers, with a visible clarification that the reference rate does not describe that household's power charge. Estimated costs continue to use actual contracted powers; combined quotes remain unavailable for unequal powers.
